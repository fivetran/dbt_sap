...
{% set columns = [
    ...
    {"name": "/vso/r_dpoint", "datatype": dbt.type_string(), "alias": "_vso_r_dpoint", "quote": true},
    {"name": "/vso/r_i_no_lyr", "datatype": dbt.type_string(), "alias": "_vso_r_i_no_lyr", "quote": true},
    {"name": "/vso/r_load_pref", "datatype": dbt.type_string(), "alias": "_vso_r_load_pref", "quote": true},
    {"name": "/vso/r_matpal", "datatype": dbt.type_string(), "alias": "_vso_r_matpal", "quote": true},
    {"name": "/vso/r_one_mat", "datatype": dbt.type_string(), "alias": "_vso_r_one_mat", "quote": true},
    {"name": "/vso/r_one_sort", "datatype": dbt.type_string(), "alias": "_vso_r_one_sort", "quote": true},
    {"name": "/vso/r_pal_ul", "datatype": dbt.type_string(), "alias": "_vso_r_pal_ul", "quote": true},
    {"name": "/vso/r_palhgt", "datatype": dbt.type_numeric(), "alias": "_vso_r_palhgt", "quote": true},
    {"name": "/vso/r_pk_mat", "datatype": dbt.type_string(), "alias": "_vso_r_pk_mat", "quote": true},
    {"name": "/vso/r_uld_side", "datatype": dbt.type_string(), "alias": "_vso_r_uld_side", "quote": true},
    {"name": "/xlso/client", "datatype": dbt.type_string(), "alias": "_xlso_client", "quote": true},
    {"name": "/xlso/customer", "datatype": dbt.type_string(), "alias": "_xlso_customer", "quote": true},
    {"name": "/xlso/partner", "datatype": dbt.type_string(), "alias": "_xlso_partner", "quote": true},
    {"name": "/xlso/pref_pay", "datatype": dbt.type_string(), "alias": "_xlso_pref_pay", "quote": true},
    {"name": "/xlso/sysid", "datatype": dbt.type_string(), "alias": "_xlso_sysid", "quote": true},
