...
{% set columns = [
    ...
    {"name": "/accgo/assgd_uom", "datatype": dbt.type_string(), "alias": "_accgo_assgd_uom", "quote": true},
    {"name": "/bev1/luldegrp", "datatype": dbt.type_string(), "alias": "_bev1_luldegrp", "quote": true},
    {"name": "/bev1/luleinh", "datatype": dbt.type_string(), "alias": "_bev1_luleinh", "quote": true},
    {"name": "/bev1/nestruccat", "datatype": dbt.type_string(), "alias": "_bev1_nestruccat", "quote": true},
    {"name": "/dsd/sl_toltyp", "datatype": dbt.type_string(), "alias": "_dsd_sl_toltyp", "quote": true},
    {"name": "/dsd/sv_cnt_grp", "datatype": dbt.type_string(), "alias": "_dsd_sv_cnt_grp", "quote": true},
    {"name": "/dsd/vc_group", "datatype": dbt.type_string(), "alias": "_dsd_vc_group", "quote": true},
    {"name": "/sttpec/country_ref", "datatype": dbt.type_string(), "alias": "_sttpec_country_ref", "quote": true},
    {"name": "/sttpec/prdcat", "datatype": dbt.type_string(), "alias": "_sttpec_prdcat", "quote": true},
    {"name": "/sttpec/sertype", "datatype": dbt.type_numeric(), "alias": "_sttpec_sertype", "quote": true},
    {"name": "/sttpec/syncact", "datatype": dbt.type_string(), "alias": "_sttpec_syncact", "quote": true},
    {"name": "/sttpec/syncchg", "datatype": dbt.type_string(), "alias": "_sttpec_syncchg", "quote": true},
    {"name": "/sttpec/synctime", "datatype": dbt.type_numeric(), "alias": "_sttpec_synctime", "quote": true},
    {"name": "/vso/r_bot_ind", "datatype": dbt.type_string(), "alias": "_vso_r_bot_ind", "quote": true},
    {"name": "/vso/r_kzgvh_ind", "datatype": dbt.type_string(), "alias": "_vso_r_kzgvh_ind", "quote": true},
    {"name": "/vso/r_no_p_gvh", "datatype": dbt.type_string(), "alias": "_vso_r_no_p_gvh", "quote": true},
    {"name": "/vso/r_pal_b_ht", "datatype": dbt.type_numeric(), "alias": "_vso_r_pal_b_ht", "quote": true},
    {"name": "/vso/r_pal_ind", "datatype": dbt.type_string(), "alias": "_vso_r_pal_ind", "quote": true},
    {"name": "/vso/r_pal_min_h", "datatype": dbt.type_numeric(), "alias": "_vso_r_pal_min_h", "quote": true},
    {"name": "/vso/r_pal_ovr_d", "datatype": dbt.type_numeric(), "alias": "_vso_r_pal_ovr_d", "quote": true},
    {"name": "/vso/r_pal_ovr_w", "datatype": dbt.type_numeric(), "alias": "_vso_r_pal_ovr_w", "quote": true},
    {"name": "/vso/r_quan_unit", "datatype": dbt.type_string(), "alias": "_vso_r_quan_unit", "quote": true},
    {"name": "/vso/r_stack_ind", "datatype": dbt.type_string(), "alias": "_vso_r_stack_ind", "quote": true},
    {"name": "/vso/r_stack_no", "datatype": dbt.type_string(), "alias": "_vso_r_stack_no", "quote": true},
    {"name": "/vso/r_tilt_ind", "datatype": dbt.type_string(), "alias": "_vso_r_tilt_ind", "quote": true},
    {"name": "/vso/r_tol_b_ht", "datatype": dbt.type_numeric(), "alias": "_vso_r_tol_b_ht", "quote": true},
    {"name": "/vso/r_top_ind", "datatype": dbt.type_string(), "alias": "_vso_r_top_ind", "quote": true},
