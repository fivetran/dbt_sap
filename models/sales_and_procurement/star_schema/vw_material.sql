create or replace view EC_DB.SAP_STG."VW_Material"(
	"Client_Id",
	"Material_Id",
	"Return_Code_Id",
	"_Sttpec_Syncchg",
	...
	"Source_Supply_Id",
	"Deletion_Date",
	"Material_Completion_Level_Id",
	"Warehouse_Storage_Condition_Id",
	"Overcapacity_Toler",
	"Allowed_Packaging_Weight",
	"_Sttpec_Prdcat",
	"Units_Measure_Usage",
	"Object_Type_Id",
	"Assortment_List_Type_Id",
	"Last_Change_Date",
	"Created_Date",
	"Rounding_Rule_Sled",
	"Supersession_Chain_Number",
	"Country_Of_Origin_Id",
	"_Vso_R_Top_Ind",
	"Matl_Grp_Pack_Matls_Id",
	"Quality_Inspection_Group_Id",
	"Material_Conv_Id",
	"Container_Requirements_Id",
	"Gross_Weight",
	...
	"Production_Inspection_Memo",
	"Volume_Uom_Id",
	"_Vso_R_No_P_Gvh",
	"X_Distr_Chain_Status_Id",
	...
	"Document_Change_No",
	"Percentage_Share_2",
	"Indicator_Highly_Viscous",
	"Standard_Hu_Type_Id",
	"Industry_Sector_Id",
	"Textile_Composition_Maintenance_Active",
	"Percentage_Share_3",
	"Dangerous_Goods_Packaging_Status_Id",
	"Percentage_Share_4",
	"_Vso_R_Tilt_Ind",
	"Material_Condition_Management",
	"_Vso_R_Tol_B_Ht",
	"Fashion_Information_Field_2",
	"Percentage_Share_5",
	"Adjustment_Profile_Id",
	"Valid_From_Date",
	"Excess_Volume_Tol",
	"Global_Trade_Item_Number_Variant",
	"Season_Year",
	"Document_Type",
	...
	"Component_3_Id",
	"Component_2_Id",
	"Pricing_Profile_Variants",
	"Component_4_Id",
	"Cw_Tolerance_Group_Id",
	...
	"Transfer_Sign",
	"Material_Tax_Group_Id",
	"Rollout_In_Season_Id",
	"Period_Ind_Sled",
	"_Sttpec_Country_Ref",
	"Industry_Std_Desc",
	"Serialization_Level",
	...
	"Manufacturer_Number_Id",
	"Variant_Price_Allowed",
	"Fff_Class",
	"Dg_Indicator_Profile_Id",
	"Transportation_Group_Id",
	"Handling_Unit_Type_Id",
	"Base_Uom_Id",
	"Order_Uom_Id",
	"_Vso_R_Stack_No",
	"Cw_Profile_Cw_Qty_Id",
	"Protected_Species_Management_Code_Id",
	"Page_Number",
	"_Vso_R_Pal_B_Ht",
	"_Bev1_Luldegrp",
	"_Bev1_Luleinh",
	...
	"Net_Weight",
	"Season_Category_Id",
	"Physical_Commodity_Id",
	"Product_Composition",
	"Object_Id",
	"_Vso_R_Kzgvh_Ind",
	"Anp_Code_Id",
	"Mfr_Part_Profile_Id",
	"Fashion_Information_Field_3",
	"Division_Id",
	"Season_Active_In_Inventory_Management",
	"Page_Format_Production_Memo",
	"Warehouse_Material_Group_Id",
	"Expiration_Date",
	"Generic_Material_Id",
	"Max_Pack_Length",
	"Material_Group_Id",
	"Qual_F_Freegoodsdis",
	"Serial_Number_Profile_Id",
	"Material_Is_Locked",
	"Time_Quarantine_Period_Uom_Id",
	"Comparison_Price_Unit",
	"Doc_Version",
	"Int_Material_Number_Id",
	SIZE1_ATINN,
	"Return_To_Logistics_Level_Id",
	"Maximum_Level_By_Volume",
	"Pilferable",
	"Revision_Level_Assgd",
	"_Sttpec_Sertype",
	"_Vso_R_Pal_Ind",
	"Segmentation_Strategy_Scope",
	"Ment_Uom_Id",
	"Nato_Item_Identification_Number",
	"Label_Type_Id",
	"Fashion_Information_Field_1",
	"Allowed_Packaging_Volume",
	"Cross_Plant_Cm_Id",
	"Segmentation_Structure_Id",
	"Number_Sheets",
	"Material_Type_Id",
	"Labeling_Matl_Grpg_Id",
	"Component_1_Id",
	"Material_Freight_Group_Id",
	"_Vso_R_Stack_Ind",
	"Document",
	"Medium_Id",
	...
	SIZE2_ATINN,
	"Acceptance_At_Origin",
	"Gross_Contents",
	"Indicator_Use_Season",
	"Assign_Effect_Vals",
	"Price_Band_Category_Id",
	"Pricing_Reference_Material_Id",
	"Catalog_Profile_Id",
	"Dimension_Uom_Id",
	...
	"_Sttpec_Syncact",
	"Creation_Status_Id",
	"Cont_Non_Textile_Parts_Animal_Origin",
	"Label_Form_Id",
	"Configurable_Material",
	"_Dsd_Sl_Toltyp",
	"Fashion_Grade_Id",
	"Quantity_Conversion_Method",
	"Reference_Matl_Packing_Id",
	"Packaging_Material_Type_Id",
	"Storage_Percentage",
	ERVOE,
	"Temperature_Conditions_Indicator_Id",
	"Ean",
	"_Accgo_Assgd_Uom",
	"_Vso_R_Quan_Unit",
	"Created_By",
...
from SAP_HANA_DB_SAPABAP1.MARA
Left Join SAP_HANA_DB_SAPABAP1.MAKT on 
