select 
    ...
    max(case when trans_event_type_id = '1' then posting_in_the_document_date else null end) latest_goods_receive_date,
    max(case when trans_event_type_id = '2' then posting_in_the_document_date else null end) latest_invoice_receive_date,
