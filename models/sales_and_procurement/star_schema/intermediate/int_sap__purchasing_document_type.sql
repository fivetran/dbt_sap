with t161 as (
    ...
    select
        ...
        t161.{{ adapter.quote('/sapmp/ceact') }} as sapmp_fastentry_chars_is_active,
        t161.{{ adapter.quote('/sapmp/pdact') }} as sapmp_activate_inheritance,
        t161.{{ adapter.quote('/sapmp/pprot') }} as sapmp_inheritance_log,
        t161.{{ adapter.quote('/sapmp/puser') }} as sapmp_inheritance_overwrite_user_values,
        t161.{{ adapter.quote('/sapmp/pausw') }} as sapmp_inheritance_char_selection_list,
        t161.{{ adapter.quote('/sapmp/atnam') }} as sapmp_characteristic_name,
        t161.{{ adapter.quote('/sapmp/gauf') }} as sapmp_global_local_group_may_be_undone,
