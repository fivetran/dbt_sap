select
    ...
    case when eindt in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('eindt') }} end as item_delivery_date,
    case when slfdt in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('slfdt') }} end as stat_rel_del_date,
    ...
    case when bedat in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('bedat') }} end as order_schedule_line_date,
    ...
    case when dat01 in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('dat01') }} end as committed_date,
    case when altdt in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('altdt') }} end as previous_delivery_date,
    aulwe as route_schedule_id,
    case when mbdat in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('mbdat') }} end as material_availability_date,
    mbuhr as matl_staging_tim,
    case when lddat in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('lddat') }} end as loading_date,
    lduhr as loading_tim,
    case when tddat in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('tddat') }} end as transportation_planning_date,
    tduhr as transp_plan_tim,
    case when wadat in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('wadat') }} end as goods_issue_date,
    wauhr as goods_issue_tim,
    case when eldat in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('eldat') }} end as goods_receipt_end_date,
    ...
    case when handoverdate in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('handoverdate') }} end as handover_date,
    ...
    case when handover_date in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('handover_date') }} end as transfer_date,
    no_scem as no_scem_controlling,
    case when dng_date in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('dng_date') }} end as rem_date,
