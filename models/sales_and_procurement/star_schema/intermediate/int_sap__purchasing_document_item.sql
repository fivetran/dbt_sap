select
    ...
    statu as rfq_status,
    case when aedat in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('aedat') }} end as last_changed_on_date,
    txz01 as short_text,
    ...
    case when agdat in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('agdat') }} end as quotation_deadline_date,
    ...
    mahn1 as 1st_reminder_exped,
    mahn2 as 2nd_reminder_exped,
    mahn3 as 3rd_reminder_exped,
    ...
    case when abdat in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('abdat') }} end as reconciliation_date,
    ...
    case when prdat in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('prdat') }} end as price_determination_date,
    ...
    case when lewed in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('lewed') }} end as latest_possible_goods_receipt_date,
    emlif as vendor_id,
    ...
    case when eildt in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('eildt') }} end as gr_b_settlement_from_date,
    case when drdat in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('drdat') }} end as last_transmission_date,
    druhr as tim,
    ...
    case when nlabd in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('nlabd') }} end as next_forecast_delivery_schedule_transm_date,
    case when nfabd in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('nfabd') }} end as next_jit_delivery_schedule_transmission_date,
    kzbws as special_stock_valuation,
    bonba as rebate_basis_1_val,
    fabkz as jit_sched_indicator,
    j_1aindxp as inflation_index_id,
    case when j_1aidatep in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('j_1aidatep') }} end as inflation_index_date,
    ...
    /bev1/negen_item as bev1_indicator_item_is_generated,
    /bev1/nedepfree as bev1_dependent_items_free,
    /bev1/nestruccat as bev1_structure_category,
    ...
    case when oifeedt in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('oifeedt') }} end as fee_pricing_condition_date,
    ...
    case when oidatfm1 in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('oidatfm1') }} end as valid_from_date,
    case when oidatto1 in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('oidatto1') }} end as valid_to_date,
    ...
    case when oidatfm1_gi in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('oidatfm1_gi') }} end as oidatfm1_gi,
    case when oidatto1_gi in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('oidatto1_gi') }} end as oidatto1_gi,
    ...
    /accgo/is_co_rel as accgo_call_off_applies,
    ...
    case when fsh_atp_date in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('fsh_atp_date') }} end as starting_with_atp_date,
