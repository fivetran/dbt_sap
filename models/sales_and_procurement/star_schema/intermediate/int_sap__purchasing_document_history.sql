select
    ...
    case when budat in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('budat') }} end as posting_in_the_document_date,
    menge as qty,
    ...
    case when cpudt in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('cpudt') }} end as entry_date,
    cputm as entry_tim,
    reewr as voice_val,
    ...
    bamng as bamng,
    charg as batch_id,
    case when bldat in ('00000000', ' ') then null else {{ char_yyyymmdd_to_date('bldat') }} end as document_in_document_date,
