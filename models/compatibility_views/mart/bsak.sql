...
cleared_records as (
  select
    ...
    cast(i.zollt as {{ dbt.type_string() }}) as zollt,
    cast(i.zolld as {{ dbt.type_string() }}) as zolld,
    cast(i.lzbkz as {{ dbt.type_string() }}) as lzbkz,
    cast(i.landl as {{ dbt.type_string() }}) as landl,
    cast(i.diekz as {{ dbt.type_string() }}) as diekz,
    ...
    end as {{ dbt.type_string() }}) as xesrd,
    ...
    cast(i.qsznr as {{ dbt.type_string() }}) as qsznr,
    ...
    cast(i.lnran as {{ dbt.type_string() }}) as lnran,
    cast(h.xstov as {{ dbt.type_string() }}) as xstov,
    cast(i.kzbtr as {{ dbt.type_string() }}) as kzbtr,
    ...
    cast(i.zekkn as {{ dbt.type_string() }}) as zekkn,
    ...
    cast(i.penlc1 as {{ dbt.type_numeric() }}) as penlc1,
    cast(i.penlc2 as {{ dbt.type_numeric() }}) as penlc2,
    cast(i.penlc3 as {{ dbt.type_numeric() }}) as penlc3,
    cast(i.penfc as {{ dbt.type_numeric() }}) as penfc,
    cast(i.pendays as {{ dbt.type_int() }}) as pendays,
    cast(h.penrc as {{ dbt.type_string() }}) as penrc,
    ...
    cast(i.pernr as {{ dbt.type_string() }}) as pernr,
    cast(i.vorgn as {{ dbt.type_string() }}) as vorgn,
