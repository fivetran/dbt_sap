...
| [`stg_sap__anla`](https://fivetran.github.io/dbt_sap/#!/model/model.sap.stg_sap__anla)<br>[`stg_sap__finsc_ld_cmp`](https://fivetran.github.io/dbt_sap/#!/model/model.sap.stg_sap__finsc_ld_cmp)<br>[`stg_sap__finsc_ledger_rep`](https://fivetran.github.io/dbt_sap/#!/model/model.sap.stg_sap__finsc_ledger_rep)<br>[`stg_sap__sapsll_clsnr`](https://fivetran.github.io/dbt_sap/#!/model/model.sap.stg_sap__sapsll_clsnr)<br>[`stg_sap__sapsll_maritc`](https://fivetran.github.io/dbt_sap/#!/model/model.sap.stg_sap__sapsll_maritc)<br>[`stg_sap__sapsll_nosca`](https://fivetran.github.io/dbt_sap/#!/model/model.sap.stg_sap__sapsll_nosca)<br>[`stg_sap__sapsll_tunos`](https://fivetran.github.io/dbt_sap/#!/model/model.sap.stg_sap__sapsll_tunos)<br>[`stg_sap__bkpf`](https://fivetran.github.io/dbt_sap/#!/model/model.sap.stg_sap__bkpf)<br>[`stg_sap__bseg`](https://fivetran.github.io/dbt_sap/#!/model/model.sap.stg_sap__bseg)<br>[`stg_sap__matdoc`](https://fivetran.github.io/dbt_sap/#!/model/model.sap.stg_sap__matdoc)<br>[`stg_sap__pa0000`](https://fivetran.github.io/dbt_sap/#!/model/model.sap.stg_sap__pa0000)<br>[`stg_sap__pa0001`](https://fivetran.github.io/dbt_sap/#!/model/model.sap.stg_sap__pa0001)<br>[`stg_sap__pa0007`](https://fivetran.github.io/dbt_sap/#!/model/model.sap.stg_sap__pa0007)<br>[`stg_sap__pa0008`](https://fivetran.github.io/dbt_sap/#!/model/model.sap.stg_sap__pa0008)<br>[`stg_sap__pa0031`](https://fivetran.github.io/dbt_sap/#!/model/model.sap.stg_sap__pa0031)<br>[`stg_sap__bsad_bck`](https://fivetran.github.io/dbt_sap/#!/model/model.sap.stg_sap__bsad_bck)<br>[`stg_sap__bsak_bck`](https://fivetran.github.io/dbt_sap/#!/model/model.sap.stg_sap__bsak_bck)<br>[`stg_sap__faglflexa`](https://fivetran.github.io/dbt_sap/#!/model/model.sap.stg_sap__faglflexa) | New Columns | | `_fivetran_synced` | Adds this standard Fivetran metadata column, which these models were missing. They also gain the `_fivetran_deleted` row filter above, matching every other staging model in the package — but per the Removed field row above, `_fivetran_deleted` itself isn't exposed in the output. `stg_sap__bsad_bck`, `stg_sap__bsak_bck`, and `stg_sap__faglflexa` already had `_fivetran_synced`; for those three this row is filter-only. |
