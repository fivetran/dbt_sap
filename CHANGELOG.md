...
| ---------- | ----------- | -------- | -------- | ----- |
| **Breaking:**<br><br>All `compatibility_views` models | Schema | `<target_schema>`<br>`_sap_comp_views` | `<target_schema>`<br>`_sap` | Any downstream queries, BI tools, or other dbt projects that reference these models by their old schema will break until updated to point at the new schema. |
