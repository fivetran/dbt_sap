...
## Under the Hood
- Removed redundant `sales_and_procurement_mandt_var` filter from sales and procurement intermediate models, as the SAP client filtering is already applied at the Fivetran connector level during data extraction.
