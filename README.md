...
| [sap__dim_vendor](https://fivetran.github.io/dbt_sap/#!/model/model.sap.sap__dim_rejection_reason) | Represents customer dimension data from the `lfa1` source to support dimensional reporting. SAP field names are mapped to English readable column names. |
