...
- Number of materialized models¹: 155
...
| Table | Description |
| :---- | :---- |
| [anep](https://fivetran.github.io/dbt_sap/#!/model/model.sap.anep) | Asset Line Items (ANEP) compatibility view - Reconstructs the classic SAP ANEP table from ACDOCA asset accounting lines in S/4HANA, joined with FINSC_LEDGER_REP and FINSC_LD_CMP for ledger resolution. |
| [anlp](https://fivetran.github.io/dbt_sap/#!/model/model.sap.anlp) | Asset Periodic Values (ANLP) compatibility view - Reconstructs the classic SAP ANLP table from FAAT_PLAN_VALUES in S/4HANA, with a left join to ANLA to supply the account determination group. |
...
| [faglflext](https://fivetran.github.io/dbt_sap/#!/model/model.sap.faglflext) | General Ledger Totals (FAGLFLEXT) compatibility view - Reconstructs the classic SAP FAGLFLEXT totals table from ACDOCA, FINSC_LEDGER_REP, and FINSC_LD_CMP, aggregated by fiscal year and period. |
